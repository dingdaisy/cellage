...
* **Methodology Reference:** For a comprehensive conceptual framework on handling proteomic age gaps, refer to the GitHub organ-aging tutorial by Hamilton Oh, (available at [github.com/hamiltonoh/organage](https://github.com/hamiltonoh/organage)). Note that while his repository utilizes linear models for the baseline reference curve, this study opts for LOWESS smoothing to capture non-linearity.
